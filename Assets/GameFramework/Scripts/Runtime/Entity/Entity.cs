...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class Entity : MonoBehaviour, IEntity
    {
            ...
            object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnInit with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        }
        ...
        public void OnRecycle()
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnRecycle with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        ...
        public void OnShow(object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnShow with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        }
        ...
        public void OnHide(bool isShutdown, object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnHide with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        }
        ...
        public void OnAttached(IEntity childEntity, object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnAttached with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        }
        ...
        public void OnDetached(IEntity childEntity, object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnDetached with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        }
        ...
        public void OnAttachTo(IEntity parentEntity, object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnAttachTo with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        ...
        public void OnDetachFrom(IEntity parentEntity, object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnDetachFrom with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        }
        ...
        public void OnUpdate(float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnUpdate with exception '{2}'.", Id.ToString(), EntityAssetName,
                    exception.ToString());
            }
        }
    }
