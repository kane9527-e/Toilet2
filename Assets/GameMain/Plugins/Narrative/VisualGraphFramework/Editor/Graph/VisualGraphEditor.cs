...
namespace VisualGraphEditor
{
    public sealed class VisualGraphEditor : EditorWindow
    {
        ...
        private void OnSelectionChange()
        {
            ...
            var graph = Selection.activeObject as VisualGraph;
            ...
            {
                if (!string.IsNullOrEmpty(AssetDatabase.GetAssetPath(graph))) SetVisualGraph(graph);
            }
            else
            {
        ...
        private void GenerateToolbar()
        {
            ...
            var blackboard_toggle = new ToolbarToggle();
