...
public static class JsonSerializer
{
    ...
    public static JsonElement SerializeNode(VisualGraphNode node)
    {
        return Serialize(node);
    }

    public static VisualGraphNode DeserializeNode(JsonElement e)
    {
        try
        {
            ...
            var node = ScriptableObject.CreateInstance(baseNodeType) as VisualGraphNode;
#if UNITY_EDITOR
