    ...
    internal sealed class ResourceBuilder : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            if (m_Controller.Load())
            {
                ...
                var buildEventHandlerTypeNames = m_Controller.GetBuildEventHandlerTypeNames();
                for (var i = 0; i < buildEventHandlerTypeNames.Length; i++)
            ...
            EditorGUILayout.BeginVertical(GUILayout.Width(position.width), GUILayout.Height(position.height));
            {
                ...
                EditorGUILayout.BeginVertical("box");
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    {
                        ...
                        var names = m_Controller.GetBuildEventHandlerTypeNames();
                        var selectedIndex = EditorGUILayout.Popup(m_BuildEventHandlerTypeNameIndex, names);
                    ...
                    EditorGUILayout.BeginHorizontal();
                    {
                        ...
                        GUILayout.Label(Utility.Text.Format("{0} ({1})", m_Controller.ApplicableGameVersion,
                            m_Controller.InternalResourceVersion.ToString()));
                    }
                    EditorGUILayout.EndHorizontal();
                    EditorGUILayout.BeginHorizontal();
                    {
                        ...
                        if (GUILayout.Button("Browse...", GUILayout.Width(80f))) BrowseOutputDirectory();
                    }
                    EditorGUILayout.EndHorizontal();
                    EditorGUILayout.BeginHorizontal();
                    {
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    {
                        if (GUILayout.Button("Start Build Resources")) m_OrderBuildResources = true;
                    }
                    EditorGUI.EndDisabledGroup();
                    if (GUILayout.Button("Save", GUILayout.Width(80f))) SaveConfiguration();
                }
                EditorGUILayout.EndHorizontal();
            }
            EditorGUILayout.EndVertical();
        ...
        {
            var window = GetWindow<ResourceBuilder>("Resource Builder", true);
        ...
        private void BrowseOutputDirectory()
        {
            ...
            if (!string.IsNullOrEmpty(directory)) m_Controller.OutputDirectory = directory;
        }
        ...
        private void GetBuildMessage(out string message, out MessageType messageType)
        {
            ...
            if (messageType == MessageType.Warning) return;
