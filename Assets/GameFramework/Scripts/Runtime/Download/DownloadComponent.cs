...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class DownloadComponent : GameFrameworkComponent
    {
        ...
        [SerializeField] private string m_DownloadAgentHelperTypeName =
            "UnityGameFramework.Runtime.UnityWebRequestDownloadAgentHelper";

        [SerializeField] private DownloadAgentHelperBase m_CustomDownloadAgentHelper;
        ...
        private void Start()
        {
            ...
            for (var i = 0; i < m_DownloadAgentHelperCount; i++) AddDownloadAgentHelper(i);
        }
        ...
        private void AddDownloadAgentHelper(int index)
        {
            ...
            var transform = downloadAgentHelper.transform;
        ...
        private void OnDownloadFailure(object sender, GameFramework.Download.DownloadFailureEventArgs e)
        {
            Log.Warning(
                ...
                e.SerialId.ToString(), e.DownloadPath, e.DownloadUri, e.ErrorMessage);
