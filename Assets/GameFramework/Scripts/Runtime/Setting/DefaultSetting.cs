...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class DefaultSetting
    {
        ...
        public string[] GetAllSettingNames()
        {
            ...
            foreach (var setting in m_Settings) allSettingNames[index++] = setting.Key;
        ...
        public void GetAllSettingNames(List<string> results)
        {
            ...
            results.Clear();
            foreach (var setting in m_Settings) results.Add(setting.Key);
        }
        ...
        {
            string value = null;
            if (!m_Settings.TryGetValue(settingName, out value)) return defaultValue;
