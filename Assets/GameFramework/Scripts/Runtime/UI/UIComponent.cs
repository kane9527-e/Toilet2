...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        [SerializeField] private bool m_EnableOpenUIFormUpdateEvent;

        [SerializeField] private bool m_EnableOpenUIFormDependencyAssetEvent;
        ...
        [SerializeField] private UIFormHelperBase m_CustomUIFormHelper;

        [SerializeField] private string m_UIGroupHelperTypeName = "UnityGameFramework.Runtime.DefaultUIGroupHelper";

        [SerializeField] private UIGroupHelperBase m_CustomUIGroupHelper;
        ...
        protected override void Awake()
        {
            ...
            if (m_EnableOpenUIFormSuccessEvent) m_UIManager.OpenUIFormSuccess += OnOpenUIFormSuccess;

            m_UIManager.OpenUIFormFailure += OnOpenUIFormFailure;

            if (m_EnableOpenUIFormUpdateEvent) m_UIManager.OpenUIFormUpdate += OnOpenUIFormUpdate;

            if (m_EnableOpenUIFormDependencyAssetEvent)
                m_UIManager.OpenUIFormDependencyAsset += OnOpenUIFormDependencyAsset;

            if (m_EnableCloseUIFormCompleteEvent) m_UIManager.CloseUIFormComplete += OnCloseUIFormComplete;
        }
        ...
        public bool AddUIGroup(string uiGroupName, int depth)
        {
            ...
            var uiGroupHelper = Helper.CreateHelper(m_UIGroupHelperTypeName, m_CustomUIGroupHelper, UIGroupCount);
        ...
        public UIForm[] GetUIForms(string uiFormAssetName)
        {
            ...
            for (var i = 0; i < uiForms.Length; i++) uiFormImpls[i] = (UIForm)uiForms[i];
        ...
        public void GetUIForms(string uiFormAssetName, List<UIForm> results)
        {
            ...
            foreach (var uiForm in m_InternalUIFormResults) results.Add((UIForm)uiForm);
        }
        ...
        private void OnOpenUIFormFailure(object sender, GameFramework.UI.OpenUIFormFailureEventArgs e)
        {
            ...
            if (m_EnableOpenUIFormFailureEvent) m_EventComponent.Fire(this, OpenUIFormFailureEventArgs.Create(e));
        }
