...
namespace GameMain.Scripts.Entity.Extensions
{
    public static class EntityExtension
    {
        ...
        public static Extensions.Entity GetGameEntity(this EntityComponent entityComponent, int entityId)
        {
            ...
            return (Extensions.Entity)entity.Logic;
        }

        public static void HideEntity(this EntityComponent entityComponent, Extensions.Entity entity)
        {
            entityComponent.HideEntity(entity.Entity);
        }

        public static void AttachEntity(this EntityComponent entityComponent, Extensions.Entity entity, int ownerId, string parentTransformPath = null, object userData = null)
        {
