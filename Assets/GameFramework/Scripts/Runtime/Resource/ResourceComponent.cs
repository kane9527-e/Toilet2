...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        [SerializeField] private int m_AssetPriority;
        ...
        [SerializeField] private int m_ResourcePriority;
        ...
        [SerializeField] private LoadResourceAgentHelperBase m_CustomLoadResourceAgentHelper;
        ...
        public UpdatableVersionListSerializer UpdatableVersionListSerializer =>
            m_ResourceManager.UpdatableVersionListSerializer;

        /// <summary>
        ///     获取本地只读区版本资源列表序列化器。
        /// </summary>
        public ReadOnlyVersionListSerializer ReadOnlyVersionListSerializer =>
            m_ResourceManager.ReadOnlyVersionListSerializer;

        /// <summary>
        ///     获取本地读写区版本资源列表序列化器。
        /// </summary>
        public ReadWriteVersionListSerializer ReadWriteVersionListSerializer =>
            m_ResourceManager.ReadWriteVersionListSerializer;

        /// <summary>
        ///     获取资源包版本资源列表序列化器。
        /// </summary>
        public ResourcePackVersionListSerializer ResourcePackVersionListSerializer =>
            m_ResourceManager.ResourcePackVersionListSerializer;

        /// <summary>
        ///     获取无用资源释放的等待时长，以秒为单位。
        /// </summary>
        public float LastUnloadUnusedAssetsOperationElapseSeconds { get; private set; }
        ...
        private void Start()
        {
            ...
            if (m_EditorResourceMode) return;
            ...
            var transform = m_ResourceHelper.transform;
            ...
            for (var i = 0; i < m_LoadResourceAgentHelperCount; i++) AddLoadResourceAgentHelper(i);
        }

        private void Update()
        {
            LastUnloadUnusedAssetsOperationElapseSeconds += Time.unscaledDeltaTime;
                                             ...
                                             m_MinUnloadUnusedAssetsInterval))
            {
                ...
                LastUnloadUnusedAssetsOperationElapseSeconds = 0f;
        ...
        {
            var loadResourceAgentHelper =
                Helper.CreateHelper(m_LoadResourceAgentHelperTypeName, m_CustomLoadResourceAgentHelper, index);
            ...
            var transform = loadResourceAgentHelper.transform;
