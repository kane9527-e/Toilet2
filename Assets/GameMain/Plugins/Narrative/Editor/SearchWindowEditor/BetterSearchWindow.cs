...
namespace BetterSearchWindow
{
    ...
    ///     The type of window used for the "current" window. This should just be the type that
    ///     inherits from BetterSearchWindow.
    /// </typeparam>
    /// <typeparam name="TPayload">
    ///     The type of payload that should be used in the search window. This type will
    ///     be passed to the <see cref="onItemSelected" /> callback.
    /// </typeparam>
        ...
        where TWindow : BetterSearchWindow
    {
        ...
        {
            onItemSelected = onItemSelectedCallback as Action<TPayload>;
