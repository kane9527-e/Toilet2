...
namespace VisualGraphRuntime
{
    ...
    public class VisualGraphPort
    {
        ...
        public List<VisualGraphPortConnection> Connections = new List<VisualGraphPortConnection>();
        ...
        {
            return Connections.Where(c => c.port_guid.Equals(guid)).FirstOrDefault();
        }
        ...
        {
            return Connections.Where(c => c.node_guid.Equals(guid)).FirstOrDefault();
        }
        ...
        {
            var connection = Connections.Where(p => p.port_guid.Equals(guid)).FirstOrDefault();
